...
import com.news.partybuilding.ui.adapter.provider.CenterPictureVideoItemProvider;
import com.news.partybuilding.utils.ListUtils;
...
public class NewsListAdapter extends MultipleItemRvAdapter<News, BaseViewHolder> {
  ...
  public void registerItemProvider() {
    //注册itemProvider
    mProviderDelegate.registerProvider(new CenterPictureVideoItemProvider(mChannelCode));
