...
public class CitySelectView extends ConstraintLayout {
  ...
  private RightIndexView indexSideView;
...
//                    citySelectListener.onCitySelect(new CityModel(cityInfoModel.getCityName(), cityInfoModel.getExtra()));
          citySelectListener.onCitySelect(new CityModel(cityInfoModel.getCityName()));
        }
      }
    });
    //设置定位的点击时间
  ...
  private void initListener() {
    indexSideView.setListener(new RightIndexView.OnLetterUpdateListener() {
      @Override
...
//                    cacheList.add(new CityInfoModel(CityInfoModel.TYPE_NORMAL, cityModel.getCityName(), pingYin.substring(0, 1), pingYin, cityModel.getExtra()));
          cacheList.add(new CityInfoModel(CityInfoModel.TYPE_NORMAL, cityModel.getCityName(), pingYin.substring(0, 1), pingYin, ""));
      ...
      if (hotCity != null) {
        ...
        for (CityModel cityModel : hotCity) {
          ...
          hotList.add(new CityInfoModel(0, cityModel.getCityName(), "", "", ""));
        }
