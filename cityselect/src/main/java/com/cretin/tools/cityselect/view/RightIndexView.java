...
public class RightIndexView extends View {
    ...
    public RightIndexView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RightIndexView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
